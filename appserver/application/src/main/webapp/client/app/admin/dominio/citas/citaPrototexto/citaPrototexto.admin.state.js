(function () {
    ...
    /* @ngInject */
    function stateConfig($stateProvider, STATE_HELPER, CITA_FORM_ADMIN) {
        var config = CITA_FORM_ADMIN();
        var base = "admin/cita-prototexto";
        var params = {
            base: base,
            baseUrl: "/" + base,
            translateBase: "admin.cita.prototexto.",
            templateList: '<citaPrototexto-list-admin></citaPrototexto-list-admin>',
        ...
        angular.merge(state.edit, {
            resolve: angular.merge(config.resolve, {
                /* @ngInject */
                item: function (Cita, $stateParams) {
