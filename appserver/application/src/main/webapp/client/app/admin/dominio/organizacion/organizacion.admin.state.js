(function () {
    ...
    /* @ngInject */
    function stateConfig($stateProvider,  STATE_HELPER, ORGANIZACION_FORM_ADMIN) {
        var config = ORGANIZACION_FORM_ADMIN();
        var base = "admin/organizacion";
        var params = {
            base: base,
            baseUrl: "/" + base,
            translateBase: "admin.organizacion.",
            parent:'organizacionBloqueParent',
            view: 'bloqueOrganizacion@organizacionBloqueParent',
            templateList: '<organizacion-list-admin></organizacion-list-admin>',
        ...
        angular.merge(state.edit, {
            resolve: angular.merge(config.resolve, {
                /* @ngInject */
                item: function (Organizacion, $stateParams) {
                    return Organizacion.get({id: $stateParams.id}).$promise;
                }
            })
        });
