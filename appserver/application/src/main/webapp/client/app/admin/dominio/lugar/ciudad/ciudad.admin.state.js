(function () {
    ...
    /* @ngInject */
    function stateConfig($stateProvider, STATE_HELPER, CIUDAD_FORM_ADMIN) {
        var config = CIUDAD_FORM_ADMIN();
        var base = "admin/ciudad";
        var params = {
            base: base,
            baseUrl: "/" + base,
            translateBase: "admin.ciudad.",
            parent:'lugarBloqueParent',
            view: 'bloqueLugar@lugarBloqueParent',
            templateList: '<ciudad-list-admin></ciudad-list-admin>',
        ...
        angular.merge(state.edit, {
            resolve: angular.merge(config.resolve, {
                /* @ngInject */
                item: function (Ciudad, $stateParams) {
