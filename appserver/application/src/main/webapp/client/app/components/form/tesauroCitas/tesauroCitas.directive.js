(function () {
    ...
    angular
        .module('app')
        .directive('tesauroCitas', TesauroCitas);

    function TesauroCitas() {
        return {
            replace: true,
            restrict: 'E',
            ...
            templateUrl: 'app/components/form/tesauroCitas/tesauroCitas.html',
            scope: {
                id: '@',
                label: '@',
                placeholder: '@',
    ...
    function Controller() {
        ...
        if (!vm.key) {
            vm.key = "referenciaPasivo";
        }

        if (!vm.display) {
            vm.display = "referenciaPasivo";
        }
